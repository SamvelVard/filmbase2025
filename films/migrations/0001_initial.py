    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kinopoisk_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Kinopoisk ID')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.country', verbose_name='Страна')),
                ('genres', models.ManyToManyField(to='news.genre', verbose_name='Жанр')),
                ('director', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='directed_news', to='news.person', verbose_name='Режиссер')),
                ('people', models.ManyToManyField(to='news.person', verbose_name='Актеры')),
            ],
            options={
                'verbose_name': 'Фильм',
